...
class TrueEKFNavigation:
    ...
    def initialize_qlabs_qcar(self, qlabs):
        ...
        print("QLabs QCar initialized for GPS-like positioning")
    ...
    def draw_detections(self, frame, yellow_cones, blue_cones, current_state, vision_conf, path_conf):
        """Enhanced visualization with EKF state"""
        if frame is None:
            return None
        ...
        cv2.putText(frame_copy, f"Pos Uncertainty: {pos_uncertainty:.2f}m", 
                   (10, 110), cv2.FONT_HERSHEY_SIMPLEX, 0.5, uncertainty_color, 2)
    ...
    def run_navigation(self, qlabs, show_video=True, max_runtime=600):
        """Main navigation loop with true EKF sensor fusion"""
                    ...
                    while self.running and (time.time() - start_time) < max_runtime:
                        ...
                        if front_frame is not None:
                            ...
                            if show_video:
                                ...
                                cv2.imshow('True EKF Navigation with Sensor Fusion', display_frame)
...
def setup_qlabs_connection():
    ...
    hSystem.set_title_string('True EKF Navigation with Sensor Fusion')
...
def main():
    ...
    print("=== True EKF Navigation with Sensor Fusion ===")
    print("Features:")
    ...
    try:
        ...
        navigator = TrueEKFNavigation(MODEL_PATH, PATH_FILE)
